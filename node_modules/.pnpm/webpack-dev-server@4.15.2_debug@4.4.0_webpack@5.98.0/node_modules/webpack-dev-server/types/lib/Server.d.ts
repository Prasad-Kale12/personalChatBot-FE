...
declare class Server {
  static get cli(): {
    ...
    readonly processArguments: (
      args: Record<string, import(".pnpm/webpack-dev-server@4.15.2_debug@4.4.0_webpack@5.98.0/node_modules/webpack-dev-server/types/bin/process-arguments").Argument>,
      config: any,
      values: Record<
        string,
        | string
      ...
      >
    ) => import(".pnpm/webpack-dev-server@4.15.2_debug@4.4.0_webpack@5.98.0/node_modules/webpack-dev-server/types/bin/process-arguments").Problem[] | null;
  };
  static get schema(): {
    title: string;
    type: string;
